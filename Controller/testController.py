...
def get():
    steps = ["""1. Mix together 1 cup plain Greek yogurt, 1 minced garlic clove, 1 tablespoon lemon juice, and 1/4 teaspoon salt in a bowl.""",
            """2. Cut 2 boneless, skinless chicken breasts into bite-sized pieces and season with salt and pepper.""",
